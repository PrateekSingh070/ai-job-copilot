...
export function OAuthCallbackPage() {
  useEffect(() => {
    // After an OAuth login the provider redirects back here with the access
    // token in the URL hash (e.g. #access_token=...). Store it and move on;
    // if it's missing, the sign-in didn't complete, so return to login.
