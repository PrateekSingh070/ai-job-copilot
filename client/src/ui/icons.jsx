...
export function RocketLaunchIcon({ className = "w-5 h-5" }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function BuildingOfficeIcon({ className = "w-5 h-5" }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function ArrowsRightLeftIcon({ className = "w-4 h-4" }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function ArrowDownTrayIcon({ className = "w-4 h-4" }) {
  return (
    <svg
      className={className}
      fill="none"
