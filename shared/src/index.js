...
// Shared validation schemas used by the API and clients. Grouped by the area of
// the product they belong to. Keeping them in one place means the server and the
// frontend validate requests against exactly the same rules.
...
// Wraps any payload in the standard success envelope. `meta` is a free-form bag
// for things like pagination info.
...
// Updates reuse the create shape, but every field is optional.
...
// Same filters as the list query, without pagination — used for CSV export.
...
// Import a job from a URL, optionally overriding scraped fields by hand.
